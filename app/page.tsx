      ...
      <section className="py-24 bg-background relative">
        ...
        <div className="container px-4 mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Social Media Growth */}
            <div className="bg-background-secondary rounded-xl p-8 border border-border hover:border-green-600/50 transition-all hover:shadow-lg hover:shadow-green-900/5 hover:translate-y-[-2px]">
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex items-center">
                  ...
                  <span className="text-sm">Follower growth campaigns</span>
                </li>
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-green-500 mr-2"></span>
                ...
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-green-500 mr-2"></span>
                  <span className="text-sm">Content promotion</span>
                </li>
              </ul>
              <Link
                href="/social-media"
            ...
            <div className="bg-background-secondary rounded-xl p-8 border border-border hover:border-green-600/50 transition-all hover:shadow-lg hover:shadow-green-900/5 hover:translate-y-[-2px]">
              ...
              <h3 className="text-xl font-semibold mb-3">Publication Features</h3>
              <p className="text-muted-foreground mb-4">
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-green-500 mr-2"></span>
                  <span className="text-sm">Press release distribution</span>
                </li>
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-green-500 mr-2"></span>
                ...
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-green-500 mr-2"></span>
                  <span className="text-sm">Industry-specific publications</span>
                </li>
              </ul>
              <Link
                href="/publications"
            ...
            <div className="bg-background-secondary rounded-xl p-8 border border-border hover:border-green-600/50 transition-all hover:shadow-lg hover:shadow-green-900/5 hover:translate-y-[-2px]">
              ...
              <h3 className="text-xl font-semibold mb-3">Digital Marketing Tools</h3>
              <p className="text-muted-foreground mb-4">
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-green-500 mr-2"></span>
                  <span className="text-sm">Knowledge panel creation</span>
                </li>
              </ul>
      ...
      <section className="py-24 bg-background-secondary relative">
        ...
        <div className="container px-4 mx-auto relative">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose inflnce</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-background p-6 rounded-lg border border-border hover:border-green-600/30 transition-all hover:shadow-lg hover:shadow-green-900/5">
