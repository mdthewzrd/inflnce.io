    ...
    <>
      ...
      {mounted && (
        <div className="hidden lg:block">
          <div className="absolute top-1/4 left-[15%] w-12 h-12 bg-purple-600 bg-opacity-20 rounded-full p-3 backdrop-blur-sm motion-safe:animate-floating">
            <svg className="w-full h-full text-purple-400" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div
            className="absolute top-1/3 right-[15%] w-12 h-12 bg-red-600 bg-opacity-20 rounded-full p-3 backdrop-blur-sm motion-safe:animate-floating"
          ...
          <div
            className="absolute bottom-1/4 left-[20%] w-12 h-12 bg-blue-600 bg-opacity-20 rounded-full p-3 backdrop-blur-sm motion-safe:animate-floating"
          ...
          <div
            className="absolute bottom-1/3 right-[20%] w-12 h-12 bg-green-600 bg-opacity-20 rounded-full p-3 backdrop-blur-sm motion-safe:animate-floating"
            style={{ animationDelay: "400ms" }}
          >
            <svg className="w-full h-full text-green-400" viewBox="0 0 24 24" fill="currentColor">
